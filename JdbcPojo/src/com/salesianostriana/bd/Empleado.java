...
public class Empleado {
	...
	public Empleado(int employee_id, String first_name, String last_name, String email, String phone_number,
	...
	public String toString() {
		return "Empleado [employee_id=" + employee_id + ", first_name=" + first_name + ", last_name=" + last_name
